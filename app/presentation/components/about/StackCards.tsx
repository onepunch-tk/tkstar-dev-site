		...
		<section aria-labelledby="about-stack-heading" className="flex flex-col gap-3">
			...
			<div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
				{STACK_CARDS.map((card) => (
					...
					>
						<span className="inline-block self-start rounded-full border border-accent bg-accent px-2 py-0.5 font-sans font-medium text-[11px] text-on-accent tracking-[0.04em]">
							{card.area}
						</span>

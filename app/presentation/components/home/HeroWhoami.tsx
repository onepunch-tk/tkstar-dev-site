...
const BTN_BASE =
	"inline-flex items-center gap-2 rounded-md border px-4 py-2.5 font-sans text-[13px] font-medium duration-[var(--duration-120)] ease-out motion-reduce:transition-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent";

export default function HeroWhoami() {
	return (
		<section aria-labelledby="hero-heading" className="flex flex-col gap-3 sm:gap-[22px]">
			<div className="flex items-baseline gap-0 font-sans text-faint text-xs">

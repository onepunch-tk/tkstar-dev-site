...
export default function ProjectFooterNav({ prev, next }: Props) {
	return (
		...
		>
			...
			<Link
				to="/contact"
				className="inline-flex min-h-11 items-center justify-center justify-self-center border border-accent px-4 py-2 font-sans text-[12px] text-accent no-underline transition-colors duration-[var(--duration-120)] ease-out hover:bg-accent hover:text-on-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent motion-reduce:transition-none"
			>
				의뢰하기 →
			</Link>

...
export default function ProjectRow({ project }: Props) {
	return (
		<Link
			...
			className="grid grid-cols-[1fr_auto] items-baseline gap-2.5 border-line border-b border-dashed py-3.5 font-sans text-[13px] text-fg no-underline transition-colors duration-[var(--duration-120)] ease-out hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent motion-reduce:transition-none min-[720px]:grid-cols-[72px_140px_1fr_minmax(0,200px)]"
		>
			...
			<div className="flex flex-col gap-0.5">
				<span className="font-sans text-[11px] text-accent min-[720px]:hidden">
					{project.slug}/
				</span>

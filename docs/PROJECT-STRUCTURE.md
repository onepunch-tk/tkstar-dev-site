...
| MDX 콘텐츠 작성 | `content/{projects/, legal/apps/<app_slug>/} — Post 는 D1 (scripts/seed-posts.ts 로 멱등 시드, T032 머지 후 admin write 경로로 대체)` |
